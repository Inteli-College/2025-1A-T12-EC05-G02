...
// Removed unused SelectButton import
...
export default function HistoricoPrescricoes() {
    ...
    const rota: string = 'http://127.0.0.1:5555/medicine/logs'; // Alterado para o novo endpoint
        ...
        if (searchText === '') {
            ...
            const filtered = rows.filter((row) => {
                return (
                    ...
                    row.horaPrescricao.toLocaleString('pt-BR').toLowerCase().includes(searchText.toLowerCase()) ||
