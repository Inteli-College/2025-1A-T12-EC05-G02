...
echo " API_URL='$NGROK_URL' " > /home/ec05-g2/2025-1A-T12-EC05-G02/src/robot/.env
...
NGROK_URL_FRONT=$(curl -s http://127.0.0.1:4041/api/tunnels | jq -r '.tunnels[0].public_url')
